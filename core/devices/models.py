...
class Device(models.Model):
    ...
    english_name = models.CharField(
        "نام انگلیسی دستگاه", max_length=255, blank=True, null=True
    )
    model = models.CharField("مدل دستگاه", max_length=255, blank=True, null=True)
    manufacturer = models.CharField(
        "شرکت سازنده", max_length=255, blank=True, null=True
    )
    ...
    status = models.CharField(
        "وضعیت", max_length=20, choices=STATUS_CHOICES, default="ready"
    )
