...
urlpatterns = [
    ...
    path(
        "profile/update/", ProfileUpdatePanelView.as_view(), name="update_profile_panel"
    ),
    ...
    path(
        "download-invoice/<int:request_id>/",
